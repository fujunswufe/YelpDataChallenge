...
if __name__=='__main__':
    ...
    for document in document_list:
        ...
        predict_file = open(predict_summary_path+document.business_id+'_'+document_list.user_id+'.txt', 'w')
        predict_file.write(summary)
        predict_file.close()

        reference_file = open(reference_summary_path+document.business_id+'_'+document_list.user_id+'.txt', 'w')
        reference_file.write(document.tip)
